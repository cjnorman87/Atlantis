...
class MainTabBarController: UITabBarController, UITabBarControllerDelegate {
    ...
    func setUpSerControllers() {
        ...
        //Search
        let searchNavController = templateNavController(unselected: #imageLiteral(resourceName: "AS"), selectedImage: #imageLiteral(resourceName: "S"), rootViewController: Postings(collectionViewLayout: UICollectionViewFlowLayout()))
        ...
        //Profile
        let profileNavController = templateNavController(unselected: #imageLiteral(resourceName: "AP"), selectedImage: #imageLiteral(resourceName: "P"), rootViewController: ProfileController())
